            ...
            <div className="lg:w-[65%] pt-5 mx-auto lg:px-0 px-10">
                <div className="lg:flex justify-between lg:pb-[80px] pb-5">
                    <div className="lg:mt-0 mt-5 ">
                         <span className="text-[16px] text-white block">NOVABOOST</span>
                    </div>
                    <div className="lg:mt-0 mt-5 lg:flex">
                        <div>
                            <h5 className="text-white font-[500]">Navigation</h5>
                            <Link href="" className="block text-[#B5B6B9] font-[400] text-[15px.25] mt-[16px]">footer-link</Link>
                            <Link href="" className="block text-[#B5B6B9] font-[400] text-[15px.25] mt-[16px]">footer-link</Link>
                            <Link href="" className="block text-[#B5B6B9] font-[400] text-[15px.25] mt-[16px]">footer-link</Link>
                        </div>
                ...
                <div className="lg:mt-0 mt-5 flex items-center justify-between pb-5 text-[#B5B6B9] text-[15.25px]">
